...
const Forgot = () => {
  return (
    ...
    className="h-full -mt-6 gradient-form bg-gray-200 md:h-screen rounded-lg">
      <Head>
        <title>Forgot Password | The Store</title>
      </Head>
              ...
              <div className="lg:flex lg:flex-wrap g-0">
                <div className="lg:w-6/12 px-4 md:px-0">
                  <div className="md:p-12 md:mx-6">
                    ...
                    <form>
                      <p className="mb-4 font-medium text-2xl text-center">Forgot Password</p>
                      ...
                      <div className="flex items-center hover:text-blue-500  duration-300 justify-between pb-6">
                        <Link className="mb-0 mr-2 " href={'/login'}>Already have an account?</Link>
